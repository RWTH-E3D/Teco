...
"""
    load_gml_lxml(path = "D:\\Users\\user\\Documents\\repos\\e3d_gitlab\\teco\\Examples\\FZK-Haus-LoD2-KIT-IAI-KHH-B36-V1.gml", prj = prj, method = "tabula_de")
    ...
    sim.simulate(path="C:\\Users\\user\\TEASEROutput", prj=prj, loading_time=3600,
                 result_path="C:\\Users\\user\\TEASEROutput\\results")
