...
if __name__ == '__main__':
    ...
    #prj.load_citygml(path = "D:\\Sciebo\\SmartQuart_E3D\\Geometrie\\SmartQuart_LoD2 District Models\\Final\\Bedburg\\converted or combined\\district1_LoD2.gml", method = "tabula_de")
    prj.add_residential(
        method="tabula_de",
