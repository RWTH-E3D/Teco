       ...
       for zone in building.thermal_zones:
           ...
           for rooftop in zone.rooftops:
               if rooftop:
                   ...
                   print(f"Rooftop details: {rooftop.__dict__}")
...
if __name__ == '__main__':
    ...
    #prj.load_citygml(path = "C:\\Users\\pan\\PycharmProjects\\teco\\Examples\\Bedburg_LoD2.gml", method = "tabula_de")
    prj.add_residential(
        method="tabula_de",
    ...
    prj.export_aixlib(path = "C:\\Users\\pan\\TEASEROutput")

    sim.simulate(path = "C:\\Users\\pan\\TEASEROutput", prj = prj, loading_time = 3600, result_path = "C:\\Users\\pan\\TEASEROutput\\results")
