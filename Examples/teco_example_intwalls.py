...
if __name__ == '__main__':
    ...
    prj.add_residential(
        ...
        net_leased_area=300
    ) #building is added. method and usage specify the enrichment method
    ...
    sim.simulate(path = "C:\\Users\\Pan\\TEASEROutput", prj = prj, loading_time = 3600, result_path = "C:\\Users\\Pan\\TEASEROutput\\test")
