...
def export_lca_csv_project_by_building(project, path, indicator):
    ...
    data_list = [["building_name", "net_leased_area ", "building_age_group", "a1", "a2", "a3", "a1_a3", "a4", "a5", "b1",
...
def export_lca_csv_lca_data(lca_data, file_path, indicator):

    head_row = ["building_element", "a1", "a2", "a3", "a1_a3", "a4", "a5", "b1",
                "b2", "b3", "b4", "b5", "b6", "b7", "c1",
                "c2", "c3", "c4", "d", "sum", "sum with d"]
    row = indicator_to_list(lca_data, indicator)

    export_list = [head_row, row]
