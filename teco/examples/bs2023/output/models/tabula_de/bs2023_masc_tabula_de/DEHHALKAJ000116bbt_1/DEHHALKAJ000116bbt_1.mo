...
within bs2023_masc_tabula_de.DEHHALKAJ000116bbt_1;
model DEHHALKAJ000116bbt_1
  "This is the simulation model of DEHHALKAJ000116bbt_1 with traceable ID 503"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1517.3778466796875,
    ABuilding=364.42578125,
    ASurTot=2313.0705777456283,
    numZones = 1,
    internalGainsMode = 1,
        use_C_flow = false,
    ...
    zoneParam = {
      DEHHALKAJ000116bbt_1_DataBase.DEHHALKAJ000116bbt_1_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAJ000116bbt_1/InternalGains_DEHHALKAJ000116bbt_1.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAJ000116bbt_1/AHU_DEHHALKAJ000116bbt_1.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAJ000116bbt_1/TsetHeat_DEHHALKAJ000116bbt_1.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://bs2023_masc_tabula_de/DEHHALKAJ000116bbt_1/TsetCool_DEHHALKAJ000116bbt_1.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/DEHHALKAJ000116bbt_1/DEHHALKAJ000116bbt_1.mos"
      "Simulate and Plot"),
