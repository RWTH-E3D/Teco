...
within bs2023_masc_tabula_de.DEHHALKAP0006abHbt_0;
model DEHHALKAP0006abHbt_0
  "This is the simulation model of DEHHALKAP0006abHbt_0 with traceable ID 135"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2368.290758544922,
    ABuilding=593.348388671875,
    ASurTot=3454.3817320754247,
    numZones = 1,
    internalGainsMode = 1,
        use_C_flow = false,
    ...
    zoneParam = {
      DEHHALKAP0006abHbt_0_DataBase.DEHHALKAP0006abHbt_0_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAP0006abHbt_0/InternalGains_DEHHALKAP0006abHbt_0.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAP0006abHbt_0/AHU_DEHHALKAP0006abHbt_0.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAP0006abHbt_0/TsetHeat_DEHHALKAP0006abHbt_0.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://bs2023_masc_tabula_de/DEHHALKAP0006abHbt_0/TsetCool_DEHHALKAP0006abHbt_0.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/DEHHALKAP0006abHbt_0/DEHHALKAP0006abHbt_0.mos"
      "Simulate and Plot"),
