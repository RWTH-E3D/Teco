...
within bs2023_masc_tabula_de.DEHHALKAsT0000Edbt_1;
model DEHHALKAsT0000Edbt_1
  "This is the simulation model of DEHHALKAsT0000Edbt_1 with traceable ID 761"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1081.7163391113281,
    ABuilding=241.58935546875,
    ASurTot=1505.1839978610565,
    numZones = 1,
    internalGainsMode = 1,
        use_C_flow = false,
    ...
    zoneParam = {
      DEHHALKAsT0000Edbt_1_DataBase.DEHHALKAsT0000Edbt_1_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAsT0000Edbt_1/InternalGains_DEHHALKAsT0000Edbt_1.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAsT0000Edbt_1/AHU_DEHHALKAsT0000Edbt_1.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://bs2023_masc_tabula_de/DEHHALKAsT0000Edbt_1/TsetHeat_DEHHALKAsT0000Edbt_1.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://bs2023_masc_tabula_de/DEHHALKAsT0000Edbt_1/TsetCool_DEHHALKAsT0000Edbt_1.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/DEHHALKAsT0000Edbt_1/DEHHALKAsT0000Edbt_1.mos"
      "Simulate and Plot"),
