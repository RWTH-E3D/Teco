"""
e6_multi_building_gml_lca_manual_assign.py

Like e5_multi_building_gml_lca.py, but uses the HUB4LCA statistic with
manually assigned archetypes and construction types per building.
...
ARCHETYPE_ASSIGNMENTS_EXCEL = Path(__file__).resolve().parent / "examplefiles" / "e6_template_full.xlsx"
...
EXPORT_TEMPLATE_EXCEL = None
        #Path(__file__).resolve().parent / "examplefiles" / "e6_template_empty.xlsx")
