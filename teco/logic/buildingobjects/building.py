...
"""
    ...
    def add_lca_data_heat_supply_system_ohneH(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_ohneH(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_ohneHHE(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_ohneHHE(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_ohneTWHE(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_ohneTWHE(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_no_ce(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_no_ce(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_no_d(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_no_d(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_no_s(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_no_s(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_no_tw_for_h(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_no_tw_for_h(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
    ...
    def add_lca_data_heat_supply_system_no_h_or_tw(self, use_b4=None, period_lca_scenario=None):  # todo löschen
        """Calculates environmental indicators resulting form the
        heating system (see class HeatSupplySystem)
        ...
        heat_supply_system.calc_lca_data_no_h_or_tw(use_b4, period_lca_scenario)
        lca_data += heat_supply_system.lca_data
