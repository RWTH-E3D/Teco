...
class HeatSupplySystem(HeatSupplySystem):
    ...
    def _lca_data_pipes(self):
        ...
        lca_data_steel_pipe = self._load_lca_data_template("8622539c-592c-45b0-9a4b-e5f8b4fea367", 25)
        lca_data_pipe_insulation = self._load_lca_data_template("75ce5bab-4506-4f7e-8c20-a638a98b7537", 25)
        lca_data_pipe_pb = self._load_lca_data_template("83a21998-b507-429e-bbe3-b5629e601138", 25)
    ...
    def _lca_data_heat_generator(self):
        ...
        if self.heat_system == "gas":
            if self._heat_generation == "circulating water heater":
                lca_data_circulating_water_heater = self._load_lca_data_template("8acef115-85c0-45f8-9999-9d3b87692fa7", 18)
                ...
                sizes = [400, 120, 20]
                count = {}
                lca_data_low_temp_400 = self._load_lca_data_template("cf9764d1-3aba-4e5e-8795-a8f1ee93d9e5", 20)
                lca_data_low_temp_120 = self._load_lca_data_template("38053775-45d9-4649-8299-ec8a5a60cbd9", 20)
                lca_data_low_temp_20 = self._load_lca_data_template("e1ccc83d-01d7-407a-ab59-8c3e1265e8cf", 20)
                ...
                sizes = [400, 120, 20]
                count = {}
                lca_data_condensing_400 = self._load_lca_data_template("36d1bbf3-1e67-4a93-92f5-0321cc30018a", 20)
                lca_data_condensing_120 = self._load_lca_data_template("0fa37281-b976-458b-880e-46268ca7a294", 20)
                lca_data_condensing_20 = self._load_lca_data_template("12bd4f95-1ff1-4b63-8654-e2dca3fd38fe", 20)
                volume = self.parent.simulated_heat_load / 1000
                for size in sorted(sizes, reverse=True):
                    count = volume // size
                    if count > 0:
            ...
            lca_data_tank_6400 = self._load_lca_data_template("4411ce80-6a9a-4088-94bb-426805d99bfc", 18)
            lca_data_tank_4850 = self._load_lca_data_template("8595cc43-c24f-4002-8d2b-c9386de7fae4", 18)
            lca_data_tank_2700 = self._load_lca_data_template("6e520eb3-0b5e-4c7a-b702-244f93faff73", 18)
            ...
            if self._heat_generation == "condensing":
                sizes = [400, 120, 20]
                count = {}
                lca_data_condensing_400 = self._load_lca_data_template("e88588a0-0974-4214-86bd-dcbf5caf656a", 20)
                lca_data_condensing_120 = self._load_lca_data_template("ca68d35e-ebe2-402f-8efe-d29c26dada04", 20)
                lca_data_condensing_20 = self._load_lca_data_template("0c44c3ec-2984-4985-995c-90a4881505a0", 20)
                volume = self.parent.simulated_heat_load / 1000
                for size in sorted(sizes, reverse=True):
                    count = volume // size
                    if count > 0:
                ...
                sizes = [400, 120, 20]
                count = {}
                lca_data_low_temp_400 = self._load_lca_data_template("4e5198e4-4eea-4550-8853-b76a6d6f9f05", 20)
                lca_data_low_temp_120 = self._load_lca_data_template("e69bcb28-f58b-443b-b62f-810bbdf6cedb", 20)
                lca_data_low_temp_20 = self._load_lca_data_template("2aa9cc62-46ee-447f-85e8-50d03e0574f4", 20)
                volume = self.parent.simulated_heat_load / 1000
                for size in sorted(sizes, reverse=True):
                    count = volume // size
                    if count > 0:
            ...
            lca_data_tank_1500 = self._load_lca_data_template("cf25e2c1-848a-44f4-92b7-4b77f7e3b4ec", 30)
            if self.parent.year_of_construction >= 2016 or self._year_of_retrofit >= 2016:
            ...
            if self._heat_generation == "night storage":
                lca_data_night_storage = self._load_lca_data_template("4ce46be9-2f9c-4686-aa21-7ebf34783674", 15)
                ...
                sizes = [14, 10, 7]
                count = {}
                lca_data_heatpump_air_14 = self._load_lca_data_template("4a08f220-1c52-453c-bf8f-f209586e96c8", 20)
                lca_data_heatpump_air_10 = self._load_lca_data_template("7c0455a7-fc89-4c3c-8225-d528e4375662", 20)
                lca_data_heatpump_air_7 = self._load_lca_data_template("efa279e8-0ac1-4883-b87c-0cb11e17d265", 20)
                volume = self.parent.simulated_heat_load / 1000
                for size in sorted(sizes, reverse=True):
                    count = volume // size
                    if count > 0:
                ...
                sizes = [70, 20, 10]
                count = {}
                lca_data_heatpump_ground_70 = self._load_lca_data_template("062fc223-898a-42bd-a133-8e0fe95cb7a5", 20)
                lca_data_heatpump_ground_20 = self._load_lca_data_template("063cabc8-b90e-4629-b514-a39dc10f0552", 20)
                lca_data_heatpump_ground_10 = self._load_lca_data_template("3bf7183e-741e-4fb7-a32e-574e76e3e747", 20)

                lca_data_ground_collectors_70 = self._load_lca_data_template("b12f748d-5aa2-4cf6-a0b7-46ce0465ee02", 20)
                lca_data_ground_collectors_20 = self._load_lca_data_template("3d3873a9-16dd-4771-82be-f7b79bbd3f53", 20)
                lca_data_ground_collectors_10 = self._load_lca_data_template("1a27c109-1e99-45e7-b198-7c79f926b996", 20)
                volume = self.parent.simulated_heat_load / 1000
                for size in sorted(sizes, reverse=True):
                    count = volume // size
                    if count > 0:
            ...
            sizes = [120, 20]
            count = {}
            lca_data_pellets_120 = self._load_lca_data_template("49660117-13cd-4475-a66b-a13801723a37", 20)
            lca_data_pellets_20 = self._load_lca_data_template("0e03a1c1-0aa9-4e94-bbc5-653d967b0d8d", 20)
            volume = self.parent.simulated_heat_load / 1000
            for size in sorted(sizes, reverse=True):
                count = volume // size
                if count > 0:
            ...
            lca_data_district = self._load_lca_data_template("dcd5e23a-9bec-40b6-b07c-1642fe696a2e", 30)
    ...
    def _lca_data_storage(self):
        ...
        if self._storage:
            lca_data_storage = self._load_lca_data_template("d3f58b23-9526-43be-8a32-fb583dfebfaa", 20)
        else:
            lca_data_storage = 0
    ...
    def _lca_data_pump(self):
        ...
        if self._pipe_routing_heating == "centralised":
            ...
            lca_data_pump_1000 = self._load_lca_data_template("9fe2649f-bd76-41d8-b952-0021143f1ef7", 10)
            lca_data_pump_250 = self._load_lca_data_template("b4e4d89b-e4d0-4df3-a233-deacc76b2fee", 10)
            lca_data_pump_50 = self._load_lca_data_template("301c6f09-ce88-4818-96c3-e420fe799d62", 10)
    ...
    def _lca_data_solar(self):
        ...
        if self._storage == "solar":
            lca_data_solar_collector = self.parent.net_leased_area / 100 * 3.05 * \
                                 self._load_lca_data_template("60e0575b-6cb4-4ba4-a9f0-78d8fb65c9a9", 20)
        else:
    ...
    def _lca_data_heat_transfer(self):
        ...
        if "heatpump" in self._heat_generation:
            lca_data_heat_transfer = self.parent.net_leased_area * \
                                self._load_lca_data_template("ed997c1e-274c-4d38-a5bf-2016693c91a3", 30)
        else:
            lca_data_radiator = self._load_lca_data_template("c6de5beb-ffe9-4b5f-aba8-c0c2d3528c58", 30)
    ...
    def _lca_data_fe(self):
        ...
        if self._heat_system == "gas":
            ...
            if "low temperature" in self._heat_generation:
                ...
                lca_data_fe = fe_demand * self._load_lca_data_template("e58a3c28-4818-43e3-9e72-f08267926613")

            else:
                lca_data_fe = fe_demand * self._load_lca_data_template("6167bec3-0bc2-425a-9c87-479fa310f8f2")

        elif self._heat_system == "oil":

            lca_data_fe = fe_demand * self._load_lca_data_template("63854c13-11d1-4f97-ad97-052ecd3e6e3d")

        elif self._heat_system == "biomass":

            lca_data_fe = fe_demand * self._load_lca_data_template("fb11f8ce-d3c7-4823-ba13-0c1f4a304799")

        elif self._heat_generation == "night storage":

            lca_data_fe = fe_demand * self._load_lca_data_template("149d05eb-7e8c-4755-9efa-347510b3ae4e")

        elif "heatpump air" in self._heat_generation:

            sizes = [14, 10, 7]
            count = {}
            lca_data_usage_heatpump_air_14 = self._load_lca_data_template("5b00afcd-8b26-4945-857f-e280946e823f")
            lca_data_usage_heatpump_air_10 = self._load_lca_data_template("05a620f5-e5ba-4593-a55c-690e2a47c8db")
            lca_data_usage_heatpump_air_7 = self._load_lca_data_template("4607b899-9c83-4764-a621-8e79c94887ec")
            volume = self.parent.simulated_heat_load / 1000
            for size in sorted(sizes, reverse=True):
                count = volume // size
                if count > 0:
            ...
            lca_data_fe = fe_demand * self._load_lca_data_template("3fd6d7dc-6618-42f4-b6be-f5b6f9a38763")

        else:

            if self.parent.simulated_heat_load < 120:

                lca_data_fe = fe_demand * self._load_lca_data_template("3c3a8f6b-ec6f-4358-8e7d-f42f05f59c10")

            else:

                lca_data_fe = fe_demand * self._load_lca_data_template("9b123a02-9967-4a5c-8630-eb78aa4f6c45")
